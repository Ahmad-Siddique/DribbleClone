        ...
        <div className="absolute inset-0 flex items-end opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-t from-black/70 to-transparent z-20">
          <div className="w-full flex items-center justify-between px-5 pb-4">
            ...
            <div className="flex gap-3">
              <button className="bg-white/90 hover:bg-white text-gray-700 rounded-full p-2 shadow transition z-20 flex items-center justify-center">
                <svg
                  viewBox="0 0 16 16"
                  width="20"
                  height="20"
              ...
              <button className="bg-white/90 hover:bg-white text-pink-600 rounded-full p-2 shadow transition z-20 flex items-center justify-center">
                <svg
                  viewBox="0 0 16 16"
                  width="20"
                  height="20"
